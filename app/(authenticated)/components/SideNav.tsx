...
const navItems: NavItem[] = [
  { title: "ホーム", href: "/", icon: <House className="h-5 w-5" /> },
  // {
  //   title: "動画一覧",
  //   href: "/videos",
  //   icon: <Video className="h-5 w-5" />,
  // },
  { title: "資料一覧", href: "/documents", icon: <FileText className="h-5 w-5" /> },
  // {
  //   title: "プロフィール",
  //   href: "/profile",
  //   icon: <User className="h-5 w-5" />,
  // },
  { title: "ログアウト", href: "/login", icon: <LogOut className="h-5 w-5" /> },
];
