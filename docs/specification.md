...
1. 新規登録
   ...
   - クリックして新規登録用のモーダルを表示
     ...
     - 表示順の設定：
       ...
       - 選択肢：「最初に配置」「（既存資料名）の後に配置」「最後に配置」
       - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. 資料名A」「2. 資料名B」）
...
2. 編集
   ...
   - クリックして表示したメニューから「編集」ボタンを押下して、資料の編集用のモーダルを表示
     ...
     - 表示順の変更：
       - 表示順をプルダウンで選択
       - 選択肢：「現在の位置を維持」「最初に配置」「（他の既存資料名）の後に配置」「最後に配置」
       - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. 資料名A」「2. 資料名B」）
...
1. 新規登録
   ...
   - クリックして動画の新規登録用のモーダルを表示
     ...
     - 表示順の設定：
       - カテゴリー選択後、表示順をプルダウンで選択
       - 選択肢：「最初に配置」「（既存動画名）の後に配置」「最後に配置」
       - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. 動画名A」「2. 動画名B」）
       - 選択された位置に基づいて display_order が自動的に計算・設定される
...
2. 編集
   ...
   - クリックして表示したメニューから「編集」ボタンを押下して、動画の編集用のモーダルを表示
     ...
     - 表示順の変更：
       - 表示順をプルダウンで選択
       - 選択肢：「現在の位置を維持」「最初に配置」「（他の既存動画名）の後に配置」「最後に配置」
       - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. 動画名A」「2. 動画名B」）
       - 位置を変更した場合、選択された位置に基づいて display_order が再計算される
...
1. 新規登録
   ...
   - クリックしてアプリの新規登録用のモーダルを表示
     ...
     - 表示順の設定：
       - カテゴリー選択後、表示順をプルダウンで選択
       - 選択肢：「最初に配置」「（既存アプリ名）の後に配置」「最後に配置」
       - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. アプリ名A」「2. アプリ名B」）
       - 選択された位置に基づいて display_order が自動的に計算・設定される
...
2. 編集
   ...
   - クリックして表示したメニューから「編集」ボタンを押下して、アプリの編集用のモーダルを表示
     ...
     - 表示順の変更：
       - 表示順をプルダウンで選択
       - 選択肢：「現在の位置を維持」「最初に配置」「（他の既存アプリ名）の後に配置」「最後に配置」
       - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. アプリ名A」「2. アプリ名B」）
       - 位置を変更した場合、選択された位置に基づいて display_order が再計算される
...
- 担当者
- 表示順（プルダウン選択）
  - 新規登録時：「最初に配置」「（既存資料名）の後に配置」「最後に配置」から選択
  - 編集時：「現在の位置を維持」「最初に配置」「（既存資料名）の後に配置」「最後に配置」から選択
  - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. 資料名A」「2. 資料名B」）
...
- ビデオの長さ
- 表示順（プルダウン選択）
  - 新規登録時：「最初に配置」「（既存動画名）の後に配置」「最後に配置」から選択
  - 編集時：「現在の位置を維持」「最初に配置」「（既存動画名）の後に配置」「最後に配置」から選択
  - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. 動画名A」「2. 動画名B」）
  - 選択された位置に基づいて display_order が自動的に設定される
...
- 開発者
- 表示順（プルダウン選択）
  - 新規登録時：「最初に配置」「（既存アプリ名）の後に配置」「最後に配置」から選択
  - 編集時：「現在の位置を維持」「最初に配置」「（既存アプリ名）の後に配置」「最後に配置」から選択
  - プルダウンの各コンテンツ名の冒頭には、現在の表示順を示す番号を付与（例：「1. アプリ名A」「2. アプリ名B」）
  - 選択された位置に基づいて display_order が自動的に設定される
