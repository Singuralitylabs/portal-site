...
=======
|  プログラミング学習 | 交流会 |・・ |
>>>>>>> 8463633 (動画一覧のページ内遷移を追加)
=======
|  プログラミング学習 | 交流会 |... |
>>>>>>> 1c2252b (資料一覧のページ内遷移を追加)
|                               |
|  プログラミング学習              |
|  +------------------------+   |
|  | カード | カード | カード |    |
...
メンバーが自身のプロフィール情報を閲覧・編集できる機能を提供する。ユーザー名、メールアドレス、自己紹介文、スキルなどの情報を管理できる。
...
2. プロフィール情報の表示
   ...
   - ヘッダー部分にユーザーのアバター、名前、役割、参加日、自己紹介、スキルを表示
   - スキルはタグ形式で表示

3. プロフィール情報の編集
   - タブ形式で「プロフィール編集」タブを表示
   - フォームで名前、メールアドレス、自己紹介、スキルを編集可能
   - 「保存」ボタンで変更を保存
   - 保存成功時にトースト通知を表示

### 5.3 表示項目

プロフィールヘッダーには以下の情報を表示：
