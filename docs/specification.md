...
8. [管理画面](#8-管理画面)
9. [カレンダーページ](#9-カレンダーページ)
10. [共通バリデーション仕様](#10-共通バリデーション仕様)
...
1. 新規登録
   - 管理者またはメンテナーにのみ、「アプリ紹介」ページ右上に「新規登録」ボタンを表示
   - クリックしてアプリの新規登録用のモーダルを表示
     - 内容入力後、「登録」ボタンをクリックすると、アプリデータが追加され「アプリ紹介」に遷移する
     - 「キャンセル」ボタンをクリックすると、アプリ紹介に遷移する
     - 表示順の設定
       - カテゴリー選択後、表示順をプルダウンで選択
...
2. 編集
   - 管理者またはメンテナーにのみ、「アプリ紹介」の個別カードタイトル右端に３点リーダーを設置
