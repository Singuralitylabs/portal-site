...
| `tests/api/notifications/slack-notification.test.ts` | `app/api/notifications/slack/route.ts`                                                                                                                                                                                                     | `POST`                                                                                                                                                                                                                                                                                                                                                                                           | Slack 通知 API の正常系（pending ユーザーの送信/スキップ）と未認証 401・認可 403・既通知時の再送抑止を検証する。 |
